...
class Card extends Component {
  ...
  componentDidMount() {
    this.apiUrl = `http://api.openweathermap.org/data/2.5/weather?q=${encodeURI(
      this.props.city
    ...
    return (
      <div className="card">
        <i
          ...
          onClick={() => this.props.removeCity(this.props.city)}
        >
          delete
        </i>
        <div onClick={() => this.props.toggleCards(false, this.props.city)}>
          ...
          <img
            ...
            src={
              this.state.mainDescription
                ? require(`../images/${this.state.mainDescription.toLowerCase()}.png`)
                : null
            }
            alt={`${this.state.iconDescription}`}
          ></img>
          ...
          <div className="minmax-container">
            <MinMaxTemp
              temp={this.state.minTemp}
              iconName="arrow_drop_down"
              tempDesc="Min"
              color="aqua"
            />
            <MinMaxTemp
              temp={this.state.maxTemp}
